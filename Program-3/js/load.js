var loadState = {
    ...
    preload: function () {
        ...
        // Load buttons
        game.load.image('jumpButton', 'assets/jumpButton.png', 100, 100);
        game.load.image('rightButton', 'assets/rightButton.png', 100, 100);
        game.load.image('leftButton', 'assets/leftButton.png', 100, 100);
