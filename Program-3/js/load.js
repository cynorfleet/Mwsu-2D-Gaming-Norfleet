var loadState = {
    ...
    preload: function () {
        ...
        // Load buttons
        game.load.image('jumpButton', 'assets/jumpButton.png', 25, 25);
        game.load.image('rightButton', 'assets/rightButton.png', 25, 25);
        game.load.image('leftButton', 'assets/leftButton.png', 25, 25);
