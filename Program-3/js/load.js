var loadState = {
    ...
    preload: function () {
        ...
        // Load buttons
        game.load.image('jumpButton', 'assets/jumpButton.png', 10, 10);
        game.load.image('rightButton', 'assets/rightButton.png', 10, 10);
        game.load.image('leftButton', 'assets/leftButton.png', 10, 10);
