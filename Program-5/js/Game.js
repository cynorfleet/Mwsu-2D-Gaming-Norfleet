...
TopDownGame.Game.prototype = {
    create: function () {
        ...
        this.weapon.fireRate = 460;

        //  Tell the this.weapon to track the 'player' Sprite, offset by 14px horizontally, 0 vertically
    ...
    update: function () {
        ...
        this.game.physics.arcade.collide(this.weapon, this.blockedLayer, 'bullet'.kill());
